...
configs_all = [
    ...
    ("llamacpp/mtp 131K\nQ4_K_M + MTP", 51.28, 59.72, "single-llama"),
    ("llamacpp/mtp-vision 49K\nQ4_K_M + MTP + viz", 56.52, 66.17, "single-llama"),
    ("llamacpp/default 262K\nQ3_K_XL + viz", 21.22, 20.79, "single-llama"),
    ("llama.cpp 32K\nQ4_K_M + ngram-mod", 22.04, 26.11, "single-llama"),
    ("Luce DFlash* 65K\nTQ3 greedy", 40.00, 71.65, "single-luce-watch"),
